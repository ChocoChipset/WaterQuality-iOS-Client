...
@synthesize username, password, basePath = _basePath, baseParameters, userAgent, sendParametersAsJSON, cachePolicy, timeoutInterval;
@synthesize operationQueue, HTTPHeaderFields;


+ (id)sharedClient {
    return [[self class] sharedClientWithIdentifier:@"master"];
}
